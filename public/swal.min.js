...
!((t, e) => {
		...
		return (
			(s =
				"undefined" != typeof Reflect && Reflect.get
					...
					: function (t, e, n) {
							var o = ((t, e) => {
								for (; !Object.hasOwn(t, e) && null !== (t = i(t)); );
								return t;
							})(t, e);
							if (o) {
	...
	var b = {},
		...
		O = (t) => t && "function" == typeof t.toPromise,
		L = (t) => (O(t) ? t.toPromise() : Promise.resolve(t)),
		j = (t) => t && Promise.resolve(t) === t,
		M = () => document.body.querySelector(".".concat(C.container)),
		I = (t) => {
			var e = M();
		...
		q = () => H(C.icon),
		V = () => H(C.title),
		R = () => H(C["html-container"]),
		_ = () => H(C.image),
		N = () => H(C["progress-steps"]),
		F = () => H(C["validation-message"]),
		U = () => I(".".concat(C.actions, " .").concat(C.confirm)),
		z = () => I(".".concat(C.actions, " .").concat(C.cancel)),
		W = () => I(".".concat(C.actions, " .").concat(C.deny)),
		K = () => I(".".concat(C.loader)),
		Y = () => H(C.actions),
		Z = () => H(C.footer),
		$ = () => H(C["timer-progress-bar"]),
		J = () => H(C.close),
		X = () => {
			var t = D();
			if (!t) return [];
			...
			return d(new Set(n.concat(i))).filter((t) => ht(t));
		},
		G = () =>
	...
	var _t = (t, e) => {
		...
		pe = (t) => t.touches && t.touches.length > 1,
		me = null,
		he = (t) => {
			null === me &&
	...
	var je = function e(n) {
		...
		De = (t, e, n) => {
			...
			t.disableInput(),
				Promise.resolve()
					.then(() => L(o.inputValidator(e, o.validationMessage)))
					.then((o) => {
						t.enableButtons(),
							t.enableInput(),
							o
		...
		qe = (t, e) => {
			...
			(n.showLoaderOnDeny && Be(W()), n.preDeny)
				? ((t.isAwaitingPromise = !0),
					Promise.resolve()
						.then(() => L(n.preDeny(e, n.validationMessage)))
						.then((n) => {
							!1 === n
								? (t.hideLoading(), we(t))
		...
		_e = (t, e) => {
			...
			(n.showLoaderOnConfirm && Be(), n.preConfirm)
				? (t.resetValidationMessage(),
					(t.isAwaitingPromise = !0),
					Promise.resolve()
						.then(() => L(n.preConfirm(e, n.validationMessage)))
						.then((n) => {
							ht(F()) || !1 === n
								? (t.hideLoading(), we(t))
								: Ve(t, void 0 === n ? e : n);
	...
	var fn = (t) => {
		...
		An = (e) =>
			e instanceof Element || ((e) => "object" === t(e) && e.jquery)(e);
	var kn = () => {
			if (b.timeout)
				return (
					(() => {
	...
	var Tn,
		...
		Sn = Object.freeze({
			...
			getHtmlContainer: R,
			getIcon: q,
			getIconContent: () => H(C["icon-content"]),
			getImage: _,
			getInputLabel: () => H(C["input-label"]),
			getLoader: K,
			getPopup: D,
			getProgressSteps: N,
			getTimerLeft: () => b.timeout && b.timeout.getTimerLeft(),
			getTimerProgressBar: $,
			getTitle: V,
			...
			isTimerRunning: () => !(!b.timeout || !b.timeout.isRunning()),
