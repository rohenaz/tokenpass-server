((e, t) => {
	...
	(() => {
		...
		var w = b.map((e) => "[hx-" + e + "], [data-hx-" + e + "]").join(", ");
		function d(e) {
			if (e == undefined) {
				return undefined;
			}
		...
		function e(e) {
			return wr(re().body, () => eval(e));
		}
		function t(t) {
			var e = Q.on("htmx:load", (e) => {
				t(e.detail.elt);
			});
			return e;
		}
		...
		function gt(u) {
			var f = c(u, (e) => ae(e).webSocket != null);
			if (f) {
				u.addEventListener(Qe(u)[0].trigger, (e) => {
		...
		function sr(t, r, n, e, i) {
			...
			if (ar(e)) {
				...
				if (e.multiple && e.tagName === "SELECT") {
					o = I(e.querySelectorAll("option:checked")).map((e) => e.value);
				}
				if (e.files) {
					o = I(e.files);
				}
		...
		function he(t, r, n, i, a, e) {
			...
			var k = tr(n);
			var P = rr(n);
			oe(["loadstart", "loadend", "progress", "abort"], (t) => {
				oe([b, b.upload], (e) => {
		...
		function Ar(l, u) {
			...
			if (o.shouldSwap) {
				...
				var v = mr(l, s);
				if (Object.hasOwn(v, "ignoreTitle")) {
					m = v.ignoreTitle;
				}
		...
		function Dr(e) {
			...
			if (re().readyState === "complete") {
				...
				re().addEventListener("DOMContentLoaded", () => {
					t();
				});
